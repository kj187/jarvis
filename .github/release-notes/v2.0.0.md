...
A big round since v1.12.0: the Resolved view now pages through the full history with much lower memory use, silences are easier to extend and configure, logins resume where they were interrupted, and the Helm chart can authenticate against a protected Alertmanager.
