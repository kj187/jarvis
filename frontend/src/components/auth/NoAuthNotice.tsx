...
export function NoAuthNotice() {
  ...
  return (
    ...
    >
      ...
      <div data-testid="noauth-notice-panel" className="relative z-10 w-full max-w-md rounded-surface border border-warning-edge bg-card p-6 shadow-xl space-y-4">
