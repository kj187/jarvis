...
| `internal/history` | `store_extra_test.go`, `store_resolved_test.go` | `GetClaimHistory`, silence history, streaming latest-resolved selection (refire exclusion, cluster isolation, exact TTL boundaries), `SeedResolved`, silence templates |
